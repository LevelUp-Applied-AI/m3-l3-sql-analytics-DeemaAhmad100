...
--#الهدف انه بدل ما اعمل nested loop  بستخدم ال window function  اسهل وبرتب الكود
...
-- Q9: Schema Design — Employee Certifications #ستركشر التيبل السكيما
